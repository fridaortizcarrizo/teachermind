...
import { lessons, students } from "@/data/mock-data";
...
export default function ClassHistory() {
  ...
  const filtered = lessons.filter((l) =>
    ...
    l.grammarFocus.some((g) => g.toLowerCase().includes(query.toLowerCase())) ||
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="relative">
        ...
        <Input
          placeholder="Search by topic, grammar, or objective..."
          value={query}
          ...
          return (
            <GlassCard key={lesson.id} variant="subtle" className="py-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-3 text-xs text-muted-foreground">
                <div><span className="font-medium">Speaking:</span> {lesson.speakingTask}</div>
